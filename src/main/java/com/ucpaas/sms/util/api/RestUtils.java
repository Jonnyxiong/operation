package com.ucpaas.sms.util.api;
...
import com.ucpaas.sms.common.util.Encodes;
...
public class RestUtils {
	...
	public static String post(String operate, String content) {
		...
		String signature = SecurityUtils.encryptMD5(
		...
		String auth = Encodes.encodeBase64(SysConstant.super_admin_sid + ":" + timestamp);// base64(主账户Id+冒号+时间戳)
